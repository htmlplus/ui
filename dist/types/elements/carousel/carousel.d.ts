...
export interface CarouselAttributesBase {
  ...
  * Can be used to conditionally apply CSS themes or variants.
  */
  "variant"?: OverridableValue<never, CarouselVariantOverrides>;
  /**
  * TODO: Indicates whether the carousel has been successfully initialized.
  */
  // @Property()
...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      "plus-carousel": CarouselEvents & CarouselAttributes & Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, keyof (CarouselEvents & CarouselAttributes)>;
    }
  }
}
