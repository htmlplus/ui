import { Q as Query, P as PlusCore, k as classes, l as ExternalDependencyError, a as jsx, b as Property, O as Overrides, c as Preset, E as Event, M as Method, W as Watch, B as Bind, d as Element } from "../core/index.js";
...
let PlusCropper = class extends PlusCore {
  ...
  render() {
    return /* @__PURE__ */ jsx("div", { className: this.classes, children: /* @__PURE__ */ jsx("img", { className: "image", alt: "cropper", src: this.src }) });
  }
};
...
__decorateClass([
  ...
  Preset()
], PlusCropper.prototype, "preset", 2);
__decorateClass([
  Event()
