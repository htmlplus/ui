import { P as PlusCore, t as toCSSColor, a as jsx, b as Property, O as Overrides, c as Preset, f as Style, d as Element } from "../core/index.js";
...
let PlusSpinner = class extends PlusCore {
  ...
  render() {
    return /* @__PURE__ */ jsx("host", { role: "status", value: this, children: /* @__PURE__ */ jsx("div", { className: "root", children: this.elements.map((element) => /* @__PURE__ */ jsx("div", {}, element)) }) });
  }
};
...
__decorateClass([
  ...
  Preset()
], PlusSpinner.prototype, "preset", 2);
__decorateClass([
  Style()
