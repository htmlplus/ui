import { P as PlusCore, a as jsx, j as jsxs, b as Property, O as Overrides, c as Preset, E as Event, B as Bind, d as Element } from "../core/index.js";
...
PlusSwitch.style = STYLE_IMPORTED;
__decorateClass([
  Property({
    reflect: true,
    type: 8
...
__decorateClass([
  ...
  Preset()
], PlusSwitch.prototype, "preset", 2);
__decorateClass([
  Event()
], PlusSwitch.prototype, "plusChange", 2);
__decorateClass([
  Bind()
], PlusSwitch.prototype, "onClick", 1);
__decorateClass([
  Bind()
], PlusSwitch.prototype, "onKeyDown", 1);
PlusSwitch = __decorateClass([
  Element()
], PlusSwitch);
export {
  PlusSwitch
