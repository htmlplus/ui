...
export class Carousel extends PlusCore {
  ...
  /**
   * Enables class injection for styling based on carousel states.
   */
  @Property()
  classes?: boolean;
  ...
  /**
   * Indicates whether the carousel has been successfully initialized.
   */
  // @Property()
  ...
  /**
   * Resets automatic behavior in the carousel.
   */
  // @Method()
  // reset() {
  //   // TODO
  ...
  /**
   * Starts automatic behavior in the carousel.
   */
  // @Method()
  // start() {
  //   // TODO
  ...
  /**
   * Stops automatic behavior in the carousel.
   */
  // @Method()
  // stop() {
  //   // TODO
